...
<head>
    ...
    <title>Zexfashionbd</title>   
    <meta name="description" content="Zexfashionbd is the leading fashion company in bangladesh.">
    <!-- xxx Favicon xxx -->    
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-lg-4 col-md-4">
          ...
          <p>We have the expertise needed to fill the requirements of our customer’s considerable insight and specialist knowledge is essential, to be in a position to advice customers to ensure they get top quality at the right price.</p>
        ...
        <div class="col-lg-4 col-md-4">
          ...
          <div class="footer-widget-menu">
            <ul class="list-unstyled">
              ...
              <li><a href="/about"><i class="icofont-simple-right"></i> <span>About us</span></a></li>
        ...
        <div class="col-lg-4 col-md-4">
          ...
          <div class="footer-widget-contact">
            <div class="media mb-3">
              ...
              <div class="media-body">House:02(3rd floor), Road:23, Sector:10, Uttara, Dhaka - 1230</div>
            </div>
            <div class="media mb-3">
            ...
            <div class="media mb-3">
              ...
              <div class="media-body">
                <div><a href="#">info@zexfashionbangladesh.com</a></div>
                <div><a href="#">atik@zexfashionbangladesh.com</a></div>
              </div>
            </div>
            <div class="media mb-3">
              <i class="icofont-clock-time mr-3"></i>
              <div class="media-body">
                <div><strong>SAT - THU</strong></div>
      ...
      <div class="container">
        <div class="row text-md-left text-center">
            <div class="col-sm-12 col-md-12 text-center">
                  Designed & Developed by <a href="https://softlooper.com" rel="nofollow">Softlooper</a> © 2019 All Rights Reserved
            </div>
        </div>
      </div>
    </div>
